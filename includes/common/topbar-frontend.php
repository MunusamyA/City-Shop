                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <!-- <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">John Doe</span><span class="user-status">Available</span></div> -->
                                <span>
                                    <img class="round" src="app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="customer_register.php"><i class="feather icon-user"></i> Register for Customer</a>
                                <a class="dropdown-item" href="seller_register.php"><i class="feather icon-user"></i> Register for Seller</a>
                                <a class="dropdown-item" href="page-user-profile.html"><i class="feather icon-user"></i> Register for Transport</a>
                               ...
                               <!-- <a class="dropdown-item" href="auth-login.html"><i class="feather icon-power"></i> Login</a> -->
                               <a class="dropdown-item" href="login.php"><i class="feather icon-log-in"></i> Login</a>
                            </div>
                        </li>
                    </ul>
                </div>
